...
## 【必须排除】以下内容禁止进入报告任何板块：
- 与南非电信行业无关的全球科技新闻（如美国AI公司融资、手机新品发布评测）
- 纯粹的促销广告、价格比较类文章（如"最便宜的手机套餐排行"）
- 体育、娱乐、生活方式内容
- 与南非本地市场无实质关联的非洲其他国家新闻（除非明确影响 MTN/Vodacom 在南非的战略）
- 重复新闻（同一事件只取信息最完整的一条）
...
- 光纤 FNO（Vumatel、Openserve、Frogfoot、MetroFibre）建设、家宽竞争
...
**T2 — 科技速览**（进入"科技速览"板块，严格限制 ≤3 条）
- 必须与南非电信有**直接关联**（如 AI 在网络优化的应用、影响运营商成本的半导体供应）
- 纯粹的全球科技新闻**不得进入此板块**
