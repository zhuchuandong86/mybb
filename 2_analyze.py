...
2. **分级**：根据影响力将新闻分为 T0 (核心事件)、T1 (关键动态)、T2 (科技速览)。
   - *T0 标准*：南非运营商（Vodacom, MTN, Telkom，Rain，Openserve，Vumatel等）相关，譬如战略、财报、业务发展、CXO发言、创新，资费、套餐、促销，5G、网络体验、网络投诉，ICASA、通信部、频谱、政策，光纤 FNO、家宽、FWA、Starlink。
...
- **筛选**：从T0级新闻提取，优先聚焦南非本地电信（MTN、Vodacom、Telkom、Rain、Vumatel；运营商、光纤 FNO、频谱、资费；智能终端、FWA、家宽等），其次考虑非洲和全球特别重大的时间；宁缺毋滥。
- **字段要求**：
  - **标题**：加上原文链接。
  - **背景**：发生了什么（<150字）。
  - **深度分析**：对行业意味着什么？（<100字）。
